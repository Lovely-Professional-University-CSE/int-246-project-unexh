...
def get_ga(form):
    ''' function to get GA solution '''
    weight_list = get_weights(form)
    value_list = get_values(form)
...
@app.route("/result")
def result():
    return render_template('result.html',title="Results",heading="Results : Max Profit",GA_Result=False,DP_Result=False,Graph_GA_Result=url_for('static',filename='images/Figure_1.png'))
